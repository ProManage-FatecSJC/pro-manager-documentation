...
Aprimoramento e criação de funções na plataforma WEB e MOBILE como: Adição de Usuários, arquivamento de parceiros e membros, função logout, edição de dados... 
