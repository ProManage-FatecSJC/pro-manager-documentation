...
Desenvolvimento do aplicativo mobile (dashboard), dashboard de informações relavantes baseadas nos dados coletados, como numero geral de processos, novos cadastros.
